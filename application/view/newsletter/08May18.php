...
<body style="margin: 0; padding: 0;">
 <table cellpadding="10" cellspacing="0" width="650" align="center">
  ...
  <tr>
    <td align="center">
      <p style="mso-line-height-rule: exactly; line-height: 150%; padding:2px">
        <a href="<?php echo Config::get('URL'); ?>reservation/newsletter/<?= $this->ver; ?>/phuket" target="_blank">
          <img src="<?php echo Config::get('URL'); ?>public/assets/img/newsletter/<?= $this->ver; ?>/location/phuket.jpg" width="285" height="374" style="padding-left: 30px;">
        </a>
      </p>
    </td>
    <td align="center">
      <p style="mso-line-height-rule: exactly; line-height: 150%; padding:2px">
        <a href="<?php echo Config::get('URL'); ?>reservation/newsletter/<?= $this->ver; ?>/bali" target="_blank">
          <img src="<?php echo Config::get('URL'); ?>public/assets/img/newsletter/<?= $this->ver; ?>/location/bali.jpg" width="285" height="374" style="padding-right: 30px;">
        </a>
      </p>
    </td>
  </tr>
  <tr>
  	<td align="center">
      <p style="mso-line-height-rule: exactly; line-height: 150%; padding:2px">
    		<a href="<?php echo Config::get('URL'); ?>reservation/newsletter/<?= $this->ver; ?>/iloilo" target="_blank">
    			<img src="<?php echo Config::get('URL'); ?>public/assets/img/newsletter/<?= $this->ver; ?>/location/iloilo.jpg" width="285" height="374" style="padding-left: 30px;">
    		</a>
      </p>
  	</td>
    <td align="center">
      <p style="mso-line-height-rule: exactly; line-height: 150%; padding:2px">
        <a href="<?php echo Config::get('URL'); ?>reservation/newsletter/<?= $this->ver; ?>/tacloban" target="_blank">
          <img src="<?php echo Config::get('URL'); ?>public/assets/img/newsletter/<?= $this->ver; ?>/location/tacloban.jpg" width="285" height="374" style="padding-right: 30px;">
        </a>
      </p>
    </td>
  </tr>
