<br><br>
<form class="js-validation-bootstrap" method="POST" action="<?php echo Config::get('URL'); ?>reservation/process">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="sidebar2">
                    ...
                    <div class="sidebar-content">
                        <h5>Package: </h5> <?= ucwords($this->packagename); ?>
                        <input type="hidden" name="packagename" value="<?= ucwords($this->packagename); ?>">
                        <input type="hidden" name="packagelocation" value="<?= ucwords($this->location); ?>">
                        <h5>Hotel: </h5> <?= ucwords($this->hotel); ?>
                        <input type="hidden" name="packagehotel" value="<?= ucwords($this->hotel); ?>">
                        <h5>Package Rate <small>(per person)</small>: </h5> &#8369;<?= number_format($this->rate); ?>
                        <input type="hidden" name="packagerate" value="<?= number_format($this->rate); ?>">
                        <h5>Check-in Date: </h5><?= $this->checkin; ?>
                        <input type="hidden" name="packagestart" value="<?= $this->checkin; ?>">
                        <h5>Check-out Date: </h5> <?= $this->checkout; ?>
                        <input type="hidden" name="packageend" value="<?= $this->checkout; ?>">
                        <h5>Adult/s: </h5> <?= $this->adult; ?>
                        <input type="hidden" name="packageadult" value="<?= $this->adult; ?>">
                        <h5>Child/s: </h5> <?= $this->child; ?>
                        <input type="hidden" name="packagechild" value="<?= $this->child; ?>">
                        <hr>
                        <h4 style="display: inline;">Total Net: &#8369;<?php $total = ($this->adult + $this->child)*$this->rate; echo number_format($total); ?></h4> 
                        <strong> 
                            
                        </strong>

                        <input type="hidden" name="packagetotal" value="<?php $total = ($this->adult + $this->child)*$this->rate; echo number_format($total); ?>">
